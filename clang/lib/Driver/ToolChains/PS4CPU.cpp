...
void toolchains::PS4PS5Base::addClangTargetOptions(
  ...
  // Default to -fvisibility-global-new-delete-none for PS5.
  if (getTriple().isPS5() && !DriverArgs.hasArg(options::OPT_fvisibility_global_new_delete_none,
                           options::OPT_fno_visibility_global_new_delete_none,
                           options::OPT_fvisibility_global_new_delete_hidden))
      CC1Args.push_back("-fvisibility-global-new-delete-none");
  const Arg *A =
